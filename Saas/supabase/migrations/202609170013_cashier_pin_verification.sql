-- Migration: 202609170013_cashier_pin_verification.sql

-- Enable pgcrypto in extensions schema if available
create extension if not exists pgcrypto with schema extensions;

-- RPC function to verify cashier 4-digit PIN for register unlock and cashier switching
...
begin
  ...
  -- Built into standard PostgreSQL library (pg_catalog) - requires NO extensions and never errors
  begin
