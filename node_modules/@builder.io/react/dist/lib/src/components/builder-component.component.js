...
var BuilderComponent = /** @class */ (function (_super) {
    ...
    function BuilderComponent(props) {
        ...
        _this.stateChangeListenerActivatedHandler = function () { return _this.notifyStateChange(); };
    ...
    BuilderComponent.prototype.componentDidMount = function () {
        ...
        if (sdk_1.Builder.isBrowser) {
            ...
            if (sdk_1.Builder.isEditing) {
                ...
                window.addEventListener('builder:component:stateChangeListenerActivated', this.stateChangeListenerActivatedHandler);
            }
    ...
    BuilderComponent.prototype.componentWillUnmount = function () {
        ...
        if (sdk_1.Builder.isBrowser) {
            ...
            window.removeEventListener('builder:component:stateChangeListenerActivated', this.stateChangeListenerActivatedHandler);
        }
    };
